...
import {
  harnessTypeValues,
  requestEventActorValues,
  requestEventTypeValues,
  requestReviewStateValues,
  requestStatusValues,
  resumeStatusValues,
  reviewActionValues,
...
export const requestEvents = sqliteTable(
  ...
  (table) => [
    index('request_events_request_id_created_at_idx').on(
      table.requestId,
      table.createdAt,
    ),
  ],
...
export type NewReviewRequestRow = typeof reviewRequests.$inferInsert;
